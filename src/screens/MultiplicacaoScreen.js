...
const MultiplicacaoScreen = ({ navigation }) => {
  ...
  const handleCalculate = () => {
    try {
      setError('');
      const calculation = calculate(val1, val2, 'multiplicacao');
  ...
  return (
    ...
    >
      <View style={globalStyles.card}>
        <Text style={globalStyles.title}>Operação de Multiplicação ✖️</Text>
...
export default MultiplicacaoScreen;
